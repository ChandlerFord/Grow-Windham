...
class OrganizationTypesControllerTest < ActionController::TestCase
  ...
  test "should create organization_type" do
    assert_difference('OrganizationType.count') do
      post :create, organization_type: { OrganizationType: @organization_type.OrganizationType, OrganizationTypeDescription: @organization_type.OrganizationTypeDescription }
    end
  ...
  test "should update organization_type" do
    patch :update, id: @organization_type, organization_type: { OrganizationType: @organization_type.OrganizationType, OrganizationTypeDescription: @organization_type.OrganizationTypeDescription }
    assert_redirected_to organization_type_path(assigns(:organization_type))
  end
