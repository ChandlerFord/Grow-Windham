...
class UserRolesControllerTest < ActionController::TestCase
  ...
  test "should create user_role" do
    assert_difference('UserRole.count') do
      post :create, user_role: { UserRole: @user_role.UserRole, UserRoleDescription: @user_role.UserRoleDescription }
    end
  ...
  test "should update user_role" do
    patch :update, id: @user_role, user_role: { UserRole: @user_role.UserRole, UserRoleDescription: @user_role.UserRoleDescription }
    assert_redirected_to user_role_path(assigns(:user_role))
  end
