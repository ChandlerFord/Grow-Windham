...
(function() {
  ...
  Previewer = (function() {
    ...
    Previewer.prototype.init = function() {
      this.el.on('adhoq:updatePreview', (function(_this) {
        return function() {
          return _this.update();
        };
      })(this));
      return this.el.on('click', (function(_this) {
        return function() {
          _this.el.trigger('adhoq:updatePreview');
          return false;
        };
      })(this));
    };
    ...
    Previewer.prototype.update = function() {
      return jQuery.ajax({
        ...
        complete: (function(_this) {
          return function(xhr) {
            return _this.result().html(xhr.responseText);
          };
        })(this)
      });
    };
...
(function() {
  var loadCurrentTableTabOnce;

  loadCurrentTableTabOnce = function($el) {
    return $el.load($el.find('a.loading').attr('href'));
  };
